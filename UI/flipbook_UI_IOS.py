...
# Form implementation generated from reading ui file 'UI/flipbook_UI_IOS.ui'
#
...
"}")
        ...
        self.tabWidget.setMinimumSize(QtCore.QSize(338, 460))
        self.tabWidget.setMaximumSize(QtCore.QSize(338, 460))
...
"")
        ...
        self.grb_frames_count.setMinimumSize(QtCore.QSize(145, 105))
        self.grb_frames_count.setMaximumSize(QtCore.QSize(16777215, 105))
...
"")
        ...
        self.fr_horizontal_line.setMinimumSize(QtCore.QSize(120, 30))
        self.fr_horizontal_line.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.sb_horizontal_line.setMinimumSize(QtCore.QSize(190, 26))
        self.sb_horizontal_line.setMaximumSize(QtCore.QSize(220, 26))
        self.sb_horizontal_line.setFocusPolicy(QtCore.Qt.WheelFocus)
...
"}")
        ...
        self.gridLayout_15.addWidget(self.sb_horizontal_line, 0, 3, 1, 1)
        self.l_vertical_count = QtWidgets.QLabel(self.fr_horizontal_line)
        self.l_vertical_count.setMinimumSize(QtCore.QSize(115, 30))
        self.l_vertical_count.setMaximumSize(QtCore.QSize(115, 30))
        ...
        self.gridLayout_15.addWidget(self.l_vertical_count, 0, 1, 1, 1)
        ...
        self.fr_vertical_line.setMinimumSize(QtCore.QSize(120, 30))
        self.fr_vertical_line.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.sb_vertical_line.setMinimumSize(QtCore.QSize(190, 26))
        self.sb_vertical_line.setMaximumSize(QtCore.QSize(220, 26))
        self.sb_vertical_line.setFocusPolicy(QtCore.Qt.WheelFocus)
...
"}")
        ...
        self.gridLayout_16.addWidget(self.sb_vertical_line, 0, 3, 1, 1)
        ...
        self.l_vertical_line.setMinimumSize(QtCore.QSize(115, 30))
        self.l_vertical_line.setMaximumSize(QtCore.QSize(115, 30))
        ...
        self.gridLayout_16.addWidget(self.l_vertical_line, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.grb_frames_count, 1, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.l_frames_tab_warning, 3, 0, 1, 1)
        spacerItem6 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_2.addItem(spacerItem6, 4, 0, 1, 1)
        self.groupBox_9 = QtWidgets.QGroupBox(self.tab_frames)
        self.groupBox_9.setMinimumSize(QtCore.QSize(320, 61))
...
"")
        ...
        self.fr_select_field = QtWidgets.QFrame(self.groupBox_9)
        self.fr_select_field.setMinimumSize(QtCore.QSize(280, 30))
        self.fr_select_field.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.gridLayout_13 = QtWidgets.QGridLayout(self.fr_select_field)
        self.gridLayout_13.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_13.setObjectName("gridLayout_13")
        self.fld_image_path = QtWidgets.QLineEdit(self.fr_select_field)
        self.fld_image_path.setMinimumSize(QtCore.QSize(284, 26))
        self.fld_image_path.setMaximumSize(QtCore.QSize(284, 26))
...
"}")
        ...
        self.gridLayout_13.addWidget(self.fld_image_path, 0, 0, 1, 1)
        self.btn_image_path = QtWidgets.QToolButton(self.fr_select_field)
        self.btn_image_path.setMinimumSize(QtCore.QSize(28, 26))
        self.btn_image_path.setMaximumSize(QtCore.QSize(28, 26))
...
"}")
        ...
        self.gridLayout_13.addWidget(self.btn_image_path, 0, 2, 1, 1)
        self.gridLayout_6.addWidget(self.fr_select_field, 0, 0, 1, 1)
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.tab_mosaic)
        self.gridLayout.setContentsMargins(0, 10, 0, 0)
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName("gridLayout")
        self.groupBox_10 = QtWidgets.QGroupBox(self.tab_mosaic)
        self.groupBox_10.setMinimumSize(QtCore.QSize(320, 65))
        self.groupBox_10.setMaximumSize(QtCore.QSize(16777215, 65))
...
"")
        ...
        self.fr_sb_increment = QtWidgets.QFrame(self.groupBox_10)
        self.fr_sb_increment.setMinimumSize(QtCore.QSize(300, 30))
        self.fr_sb_increment.setMaximumSize(QtCore.QSize(16777215, 30))
        self.fr_sb_increment.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.fr_sb_increment.setFrameShadow(QtWidgets.QFrame.Raised)
        self.fr_sb_increment.setObjectName("fr_sb_increment")
        self.gridLayout_28 = QtWidgets.QGridLayout(self.fr_sb_increment)
        self.gridLayout_28.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_28.setSpacing(0)
        self.gridLayout_28.setObjectName("gridLayout_28")
        self.sb_increment = QtWidgets.QSpinBox(self.fr_sb_increment)
        self.sb_increment.setMinimumSize(QtCore.QSize(281, 26))
        self.sb_increment.setMaximumSize(QtCore.QSize(16777215, 26))
        self.sb_increment.setStyleSheet("QSpinBox{\n"
"color: rgb(203, 203, 203);\n"
"background-color: rgb(117, 117, 117);\n"
"border-radius: 8px;\n"
"padding: 5px;\n"
"}")
        self.sb_increment.setWrapping(False)
        self.sb_increment.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.sb_increment.setCorrectionMode(QtWidgets.QAbstractSpinBox.CorrectToNearestValue)
        self.sb_increment.setMinimum(1)
        self.sb_increment.setMaximum(100)
        self.sb_increment.setProperty("value", 1)
        self.sb_increment.setObjectName("sb_increment")
        self.gridLayout_28.addWidget(self.sb_increment, 0, 0, 1, 1)
        self.gridLayout_40.addWidget(self.fr_sb_increment, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.groupBox_10, 3, 0, 1, 2)
        self.groupBox_3 = QtWidgets.QGroupBox(self.tab_mosaic)
        self.groupBox_3.setMinimumSize(QtCore.QSize(320, 65))
...
"")
        ...
        self.fr_images_per_line.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.sb_images_per_line.setMinimumSize(QtCore.QSize(281, 26))
        self.sb_images_per_line.setMaximumSize(QtCore.QSize(16777215, 26))
...
"}")
        ...
        self.groupBox_2.setMinimumSize(QtCore.QSize(320, 65))
...
"")
        ...
        self.fr_frames_path.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.gridLayout_24.addItem(spacerItem8, 0, 2, 1, 1)
        self.btn_frames_path = QtWidgets.QPushButton(self.fr_frames_path)
        self.btn_frames_path.setEnabled(True)
        self.btn_frames_path.setMinimumSize(QtCore.QSize(110, 25))
        self.btn_frames_path.setMaximumSize(QtCore.QSize(110, 25))
...
"}")
        ...
        self.gridLayout_24.addWidget(self.btn_frames_path, 0, 0, 1, 1)
        ...
        self.groupBox_4.setMinimumSize(QtCore.QSize(320, 65))
...
"")
        ...
        self.fr_max_images.setMaximumSize(QtCore.QSize(16777215, 30))
        self.fr_max_images.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.sb_max_images.setMinimumSize(QtCore.QSize(281, 26))
        self.sb_max_images.setMaximumSize(QtCore.QSize(16777215, 26))
...
"}")
        ...
        self.sb_max_images.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.l_mosaic_tab_warning.setMinimumSize(QtCore.QSize(320, 80))
...
"}")
        ...
        self.gridLayout.addWidget(self.l_mosaic_tab_warning, 6, 0, 1, 2)
        self.groupBox_5 = QtWidgets.QGroupBox(self.tab_mosaic)
        self.groupBox_5.setMinimumSize(QtCore.QSize(320, 65))
...
"")
        ...
        self.fr_background_color.setMaximumSize(QtCore.QSize(16777215, 40))
        self.fr_background_color.setFrameShape(QtWidgets.QFrame.NoFrame)
...
"}")
        ...
        self.gridLayout_35.addWidget(self.sb_background_color_a, 1, 7, 1, 1)
        self.sb_background_color_g = QtWidgets.QSpinBox(self.fr_background_color)
        self.sb_background_color_g.setMinimumSize(QtCore.QSize(70, 26))
        self.sb_background_color_g.setMaximumSize(QtCore.QSize(70, 26))
...
"}")
        ...
        self.gridLayout_35.addWidget(self.sb_background_color_g, 1, 2, 1, 1)
        self.sb_background_color_b = QtWidgets.QSpinBox(self.fr_background_color)
        self.sb_background_color_b.setMinimumSize(QtCore.QSize(70, 26))
        self.sb_background_color_b.setMaximumSize(QtCore.QSize(70, 26))
...
"}")
        ...
        self.gridLayout_35.addWidget(self.sb_background_color_b, 1, 4, 1, 1)
        self.sb_background_color_r = QtWidgets.QSpinBox(self.fr_background_color)
        self.sb_background_color_r.setMinimumSize(QtCore.QSize(70, 26))
        self.sb_background_color_r.setMaximumSize(QtCore.QSize(70, 26))
...
"}")
        ...
        self.gridLayout_35.addWidget(self.sb_background_color_r, 1, 0, 1, 1)
        ...
        self.gridLayout.addItem(spacerItem13, 7, 0, 1, 2)
        ...
        self.gridLayout_43.setContentsMargins(0, 10, 0, 0)
        ...
        self.gridLayout_43.addItem(spacerItem14, 4, 0, 1, 1)
        self.groupBox_8 = QtWidgets.QGroupBox(self.tab_output)
        self.groupBox_8.setMinimumSize(QtCore.QSize(320, 65))
...
"")
        ...
        self.fr_image_format.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.cb_image_format.setMinimumSize(QtCore.QSize(70, 26))
        self.cb_image_format.setMaximumSize(QtCore.QSize(70, 26))
...
"}")
        ...
        self.cb_image_format.addItem("")
        self.cb_image_format.addItem("")
        self.gridLayout_19.addWidget(self.cb_image_format, 0, 2, 1, 1)
        ...
        self.fld_filename.setMinimumSize(QtCore.QSize(230, 26))
        self.fld_filename.setMaximumSize(QtCore.QSize(16777215, 230))
...
"}")
        ...
        self.gridLayout_19.addWidget(self.fld_filename, 0, 0, 1, 1)
        ...
        self.groupBox_6.setMinimumSize(QtCore.QSize(320, 65))
...
"")
        ...
        self.fr_outpath.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.btn_out_path.setMinimumSize(QtCore.QSize(28, 26))
        self.btn_out_path.setMaximumSize(QtCore.QSize(28, 26))
...
"}")
        ...
        self.fld_out_path.setMinimumSize(QtCore.QSize(284, 26))
        self.fld_out_path.setMaximumSize(QtCore.QSize(284, 26))
...
"}")
        ...
        self.groupBox_7.setMinimumSize(QtCore.QSize(320, 105))
        self.groupBox_7.setMaximumSize(QtCore.QSize(16777215, 105))
...
"")
        ...
        self.fr_valid_frame_range.setMaximumSize(QtCore.QSize(16777215, 30))
        self.fr_valid_frame_range.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.cb_valid_frame_range.setMinimumSize(QtCore.QSize(200, 26))
        self.cb_valid_frame_range.setMaximumSize(QtCore.QSize(200, 26))
...
" }")
        ...
        spacerItem16 = QtWidgets.QSpacerItem(107, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_33.addItem(spacerItem16, 0, 1, 1, 1)
        self.gridLayout_32.addWidget(self.fr_valid_frame_range, 0, 0, 1, 1)
        self.fr_start_end_inc = QtWidgets.QFrame(self.groupBox_7)
        self.fr_start_end_inc.setMinimumSize(QtCore.QSize(305, 30))
        self.fr_start_end_inc.setMaximumSize(QtCore.QSize(16777215, 30))
        self.fr_start_end_inc.setFrameShape(QtWidgets.QFrame.NoFrame)
...
"}")
        ...
        self.sb_end_value.setProperty("value", 1)
        ...
        self.gridLayout_21.addItem(spacerItem17, 2, 5, 1, 1)
        spacerItem18 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_21.addItem(spacerItem18, 2, 3, 1, 1)
        spacerItem19 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_21.addItem(spacerItem19, 2, 1, 1, 1)
...
"}")
        ...
        self.sb_inc_value.setProperty("value", 1)
...
"")
        ...
        self.sb_start_value.setProperty("value", 1)
        ...
        self.l_start_end_inc.setMinimumSize(QtCore.QSize(105, 25))
        self.l_start_end_inc.setMaximumSize(QtCore.QSize(105, 25))
        ...
        self.gridLayout_21.addWidget(self.l_start_end_inc, 2, 0, 1, 1)
        ...
        self.fr_save_butons.setMinimumSize(QtCore.QSize(320, 30))
        self.fr_save_butons.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.btn_save.setMinimumSize(QtCore.QSize(110, 25))
        self.btn_save.setMaximumSize(QtCore.QSize(110, 25))
...
"}")
        ...
        self.gridLayout_43.addItem(spacerItem21, 6, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_9.setTitle(_translate("MainWindow", "Image"))
        ...
        self.groupBox_10.setTitle(_translate("MainWindow", "Increment"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Images per line"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Select frames"))
        ...
        self.cb_valid_frame_range.setItemText(2, _translate("MainWindow", "Render Mosaic Frame"))
